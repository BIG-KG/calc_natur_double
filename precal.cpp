# 1 ".\\sourse\\calculator.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 ".\\sourse\\calculator.cpp"
# 12 ".\\sourse\\calculator.cpp"
...
int easy_const_const (node_t *currNode)
{
        ...
        isOperation(currNode) )
    {
        ...
        switch (currNode->data.nodeData.func)
        {
# 428 ".\\sourse\\calculator.cpp"
# 1 ".\\sourse\\codegen.cpp" 1

case SUM: currNode->data.nodeData.cnst = righCons "+" leftCons; break;;
case SUB: currNode->data.nodeData.cnst = righCons "-" leftCons; break;;
case MUL: currNode->data.nodeData.cnst = righCons "*" leftCons; break;;
# 429 ".\\sourse\\calculator.cpp" 2
